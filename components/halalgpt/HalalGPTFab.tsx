...
// Positionné au-dessus de la BottomNav mobile (56px + safe-area), sous ses
...
export default function HalalGPTFab({ en = false }: { en?: boolean }) {
  ...
  return (
    <a
      href={href}
      className="fixed right-4 md:right-6 bottom-[calc(68px+env(safe-area-inset-bottom,0px))] md:bottom-6 flex items-center gap-2 min-h-[52px] px-5 rounded-full font-bold text-[15px] transition-transform hover:scale-105"
      style={{
        zIndex: 90,
