  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      <button onClick={() => setOpen((o) => !o)} aria-label="Changer de langue"
        style={{ display: 'flex', alignItems: 'center', gap: '6px', minHeight: 44, background: 'none', border: 'none', cursor: 'pointer', color: 'inherit', fontSize: '13px', fontWeight: 700, padding: '0 8px' }}>
