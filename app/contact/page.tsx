      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-14 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="space-y-6">
            {[
              { icon: '✉️', title: 'E-mail', detail: 'contact@voyageshalal.fr' },
              { icon: '💬', title: 'WhatsApp', detail: '+33 · Réponse sous 24h' },
              { icon: '🤝', title: 'Partenariats', detail: 'Restaurants, hôtels, agences de voyage' },
              { icon: '📍', title: 'Signaler un lieu', detail: 'Aidez la communauté en ajoutant un restaurant ou une mosquée' },
            ].map((item) => (
