...
// Déployé le 15 août : si tu lis « Pas cher · Proche · Bien noté » à
// l'écran, c'est cette version-là qui tourne. Sinon, la production est
// restée sur un commit antérieur.
