...
export const moreDict: Record<Lang, Record<string, string>> = {
  fr: { 'home.greet': 'où allez-vous prier ?', 'home.next': 'Prochaine prière', 'home.allTimes': 'Touchez pour tous les horaires →', 'home.popular': 'Destinations populaires', 'home.seeAll': 'Voir toutes les destinations →', 'tile.destSub': 'villes halal', 'tile.praySub': 'Horaires du jour', 'tile.qiblaSub': 'Direction Mecque', 'tile.mosqueSub': 'La plus proche', 'geo.title': 'Tout le halal autour de vous', 'geo.sub': 'Mosquées, horaires de prière et Qibla — en un clic', 'geo.btn': '📍 Localise-moi' },
  en: { 'home.greet': 'where will you pray?', 'home.next': 'Next prayer', 'home.allTimes': 'Tap for all prayer times →', 'home.popular': 'Popular destinations', 'home.seeAll': 'See all destinations →', 'tile.destSub': 'halal cities', 'tile.praySub': "Today's times", 'tile.qiblaSub': 'Mecca direction', 'tile.mosqueSub': 'Nearest one', 'geo.title': 'All things halal around you', 'geo.sub': 'Mosques, prayer times and Qibla — in one tap', 'geo.btn': '📍 Locate me' },
