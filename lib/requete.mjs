...
export const TEXTE_PAR_DEFAUT = {
  pizza: 'pizzeria', kebab: 'kebab', burger: 'burger',
  oriental: 'restaurant oriental', asiatique: 'restaurant asiatique',
  'petit-dejeuner': 'petit-déjeuner', patisserie: 'pâtisserie boulangerie',
  'peu-importe': 'restaurant',
}
 ...
 * · manger   → LES MOTS DU VISITEUR, TELS QUELS. Jamais « halal » devant.
 *
 * 🔴🔴 « LE TYPE D'ABORD, LE HALAL ENSUITE » — Mohamed, 16 août :
 *
 *   « On accole "halal" au mot du visiteur avant d'interroger Google.
 ...
 *     épiceries. Le visiteur demande un café, on lui répond
 *     "établissement musulman". »
 *
 * Un café est un café, un kebab est un kebab. On cherche LE TYPE DEMANDÉ,
 * et le statut halal se qualifie SUR LES RÉSULTATS — c'est le rôle de
 * halalPrudent.mjs et du barrage alcool, pas celui de la requête.
 *
 * Si le visiteur écrit « halal » lui-même, on le garde : c'est son mot.
 */
